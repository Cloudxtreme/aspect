...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbonentStatusChanges.successfully'
        db.add_column(u'journaling_abonentstatuschanges', 'successfully',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServiceStatusChanges.successfully'
        db.add_column(u'journaling_servicestatuschanges', 'successfully',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbonentStatusChanges.successfully'
        db.delete_column(u'journaling_abonentstatuschanges', 'successfully')

        # Deleting field 'ServiceStatusChanges.successfully'
        db.delete_column(u'journaling_servicestatuschanges', 'successfully')
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
