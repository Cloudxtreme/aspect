...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServicePlanChanges'
        db.create_table(u'journaling_serviceplanchanges', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('attach', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('laststatus', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ...
            ('successfully', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal(u'journaling', ['ServicePlanChanges'])


    def backwards(self, orm):
        # Deleting model 'ServicePlanChanges'
        db.delete_table(u'journaling_serviceplanchanges')
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'mac': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '17', 'null': 'True', 'blank': 'True'}),
        ...
        u'journaling.log': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.CharField', [], {'default': "'C'", 'max_length': '1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        u'journaling.serviceplanchanges': {
            'Meta': {'object_name': 'ServicePlanChanges'},
            'attach': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'done': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 27, 0, 0)'}),
