...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceStatusChanges.datetimefinish'
        db.add_column(u'journaling_servicestatuschanges', 'datetimefinish',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServiceStatusChanges.datetimefinish'
        db.delete_column(u'journaling_servicestatuschanges', 'datetimefinish')
