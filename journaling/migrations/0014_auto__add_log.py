...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Log'
        db.create_table(u'journaling_log', (
            ...
            ('level', self.gf('django.db.models.fields.CharField')(default='C', max_length=1)),
        ))
        db.send_create_signal(u'journaling', ['Log'])


    def backwards(self, orm):
        # Deleting model 'Log'
        db.delete_table(u'journaling_log')
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 26, 0, 0)'}),
