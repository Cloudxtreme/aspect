...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DeviceStatusEntry.status'
        db.delete_column(u'journaling_devicestatusentry', 'status')

        # Adding field 'DeviceStatusEntry.state_up'
        db.add_column(u'journaling_devicestatusentry', 'state_up',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'DeviceStatusEntry.device'
        db.alter_column(u'journaling_devicestatusentry', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Device']))

    def backwards(self, orm):
        # Adding field 'DeviceStatusEntry.status'
        db.add_column(u'journaling_devicestatusentry', 'status',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)

        # Deleting field 'DeviceStatusEntry.state_up'
        db.delete_column(u'journaling_devicestatusentry', 'state_up')


        # Changing field 'DeviceStatusEntry.device'
        db.alter_column(u'journaling_devicestatusentry', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vlans.Device']))
