...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AbonentStatusChanges.comment'
        db.alter_column(u'journaling_abonentstatuschanges', 'comment', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'ServiceStatusChanges.comment'
        db.alter_column(u'journaling_servicestatuschanges', 'comment', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'AbonentStatusChanges.comment'
        db.alter_column(u'journaling_abonentstatuschanges', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'ServiceStatusChanges.comment'
        db.alter_column(u'journaling_servicestatuschanges', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=30))
