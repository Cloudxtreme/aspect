...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AbonentStatusChanges.datetime'
        db.delete_column(u'journaling_abonentstatuschanges', 'datetime')

        # Adding field 'AbonentStatusChanges.date'
        db.add_column(u'journaling_abonentstatuschanges', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2014, 7, 9, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'DeviceStatusEntry.datetime'
        db.delete_column(u'journaling_devicestatusentry', 'datetime')

        # Adding field 'DeviceStatusEntry.date'
        db.add_column(u'journaling_devicestatusentry', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 9, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'ServiceStatusChanges.datetime'
        db.delete_column(u'journaling_servicestatuschanges', 'datetime')

        # Adding field 'ServiceStatusChanges.date'
        db.add_column(u'journaling_servicestatuschanges', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2014, 7, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AbonentStatusChanges.datetime'
        db.add_column(u'journaling_abonentstatuschanges', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2014, 7, 9, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'AbonentStatusChanges.date'
        db.delete_column(u'journaling_abonentstatuschanges', 'date')

        # Adding field 'DeviceStatusEntry.datetime'
        db.add_column(u'journaling_devicestatusentry', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 9, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'DeviceStatusEntry.date'
        db.delete_column(u'journaling_devicestatusentry', 'date')

        # Adding field 'ServiceStatusChanges.datetime'
        db.add_column(u'journaling_servicestatuschanges', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2014, 7, 9, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'ServiceStatusChanges.date'
        db.delete_column(u'journaling_servicestatuschanges', 'date')
    ...
    models = {
        ...
        u'journaling.devicestatusentry': {
            'Meta': {'object_name': 'DeviceStatusEntry'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['vlans.Device']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'journaling.servicestatuschanges': {
            ...
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'datetimefinish': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'laststatus': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
            'newstatus': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
