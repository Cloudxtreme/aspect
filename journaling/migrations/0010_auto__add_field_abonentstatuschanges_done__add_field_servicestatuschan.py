...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbonentStatusChanges.done'
        db.add_column(u'journaling_abonentstatuschanges', 'done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServiceStatusChanges.done'
        db.add_column(u'journaling_servicestatuschanges', 'done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbonentStatusChanges.done'
        db.delete_column(u'journaling_abonentstatuschanges', 'done')

        # Deleting field 'ServiceStatusChanges.done'
        db.delete_column(u'journaling_servicestatuschanges', 'done')
