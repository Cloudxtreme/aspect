...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AbonentStatusChanges.date'
        db.alter_column(u'journaling_abonentstatuschanges', 'date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ServiceStatusChanges.date'
        db.alter_column(u'journaling_servicestatuschanges', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'AbonentStatusChanges.date'
        db.alter_column(u'journaling_abonentstatuschanges', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

        # Changing field 'ServiceStatusChanges.date'
        db.alter_column(u'journaling_servicestatuschanges', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
