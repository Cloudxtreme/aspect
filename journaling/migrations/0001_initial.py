...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServiceStatusChanges'
        db.create_table(u'journaling_servicestatuschanges', (
        ...
        db.send_create_signal(u'journaling', ['ServiceStatusChanges'])

        # Adding model 'AbonentStatusChanges'
        db.create_table(u'journaling_abonentstatuschanges', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('attach', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('abonent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Abonent'])),
            ('laststatus', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('newstatus', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'journaling', ['AbonentStatusChanges'])


    def backwards(self, orm):
        # Deleting model 'ServiceStatusChanges'
        db.delete_table(u'journaling_servicestatuschanges')

        # Deleting model 'AbonentStatusChanges'
        db.delete_table(u'journaling_abonentstatuschanges')
    ...
    models = {
        u'journaling.abonentstatuschanges': {
            ...
            'laststatus': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
