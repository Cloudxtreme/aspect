...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TroubleTicket.solve_date'
        db.alter_column(u'tt_troubleticket', 'solve_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'TroubleTicket.solve_date'
        db.alter_column(u'tt_troubleticket', 'solve_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 25, 0, 0)))
