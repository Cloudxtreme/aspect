...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TroubleTicket', fields ['number']
        db.create_unique(u'tt_troubleticket', ['number'])


    def backwards(self, orm):
        # Removing unique constraint on 'TroubleTicket', fields ['number']
        db.delete_unique(u'tt_troubleticket', ['number'])
    ...
    models = {
        ...
        u'tt.troubleticket': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.CharField', [], {'default': "u'2'", 'unique': 'True', 'max_length': '30'}),
