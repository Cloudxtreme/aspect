...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TroubleTicketCategory'
        db.create_table(u'tt_troubleticketcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'tt', ['TroubleTicketCategory'])

        # Adding model 'TroubleTicket'
        db.create_table(u'tt_troubleticket', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('abonent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Abonent'])),
            ('performer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tt.TroubleTicketCategory'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('solve_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'tt', ['TroubleTicket'])

        # Adding model 'TroubleTicketComment'
        db.create_table(u'tt_troubleticketcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tt', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tt.TroubleTicket'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'tt', ['TroubleTicketComment'])


    def backwards(self, orm):
        # Deleting model 'TroubleTicketCategory'
        db.delete_table(u'tt_troubleticketcategory')

        # Deleting model 'TroubleTicket'
        db.delete_table(u'tt_troubleticket')

        # Deleting model 'TroubleTicketComment'
        db.delete_table(u'tt_troubleticketcomment')
    ...
    models = {
        ...
        u'tt.troubleticket': {
            'Meta': {'object_name': 'TroubleTicket'},
            'abonent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Abonent']"}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tt.TroubleTicketCategory']"}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '2000'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'performer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'solve_date': ('django.db.models.fields.DateTimeField', [], {})
        },
        u'tt.troubleticketcategory': {
            'Meta': {'object_name': 'TroubleTicketCategory'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        u'tt.troubleticketcomment': {
            'Meta': {'object_name': 'TroubleTicketComment'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '2000'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tt': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tt.TroubleTicket']"})
        },
        u'users.abonent': {
