...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TroubleTicket.create_date'
        db.alter_column(u'tt_troubleticket', 'create_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'TroubleTicket.create_date'
        db.alter_column(u'tt_troubleticket', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
