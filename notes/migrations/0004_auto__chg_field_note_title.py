...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'notes_note', 'title', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'Note.title'
        db.alter_column(u'notes_note', 'title', self.gf('django.db.models.fields.CharField')(max_length=20))
