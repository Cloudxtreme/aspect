...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'contacts_contact', 'surname', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Contact.surname'
        db.alter_column(u'contacts_contact', 'surname', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        u'contacts.contact': {
            ...
            'position': ('django.db.models.fields.CharField', [], {'max_length': '70', 'null': 'True', 'blank': 'True'}),
            'primary_contact': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
