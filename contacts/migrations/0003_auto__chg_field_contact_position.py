...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.position'
        db.alter_column(u'contacts_contact', 'position', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))

    def backwards(self, orm):

        # Changing field 'Contact.position'
        db.alter_column(u'contacts_contact', 'position', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
