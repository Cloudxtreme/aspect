...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.primary_contact'
        db.add_column(u'contacts_contact', 'primary_contact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.primary_contact'
        db.delete_column(u'contacts_contact', 'primary_contact')
