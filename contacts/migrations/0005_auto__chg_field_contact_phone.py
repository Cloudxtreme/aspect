...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'contacts_contact', 'phone', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Contact.phone'
        db.alter_column(u'contacts_contact', 'phone', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
