...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'devices_devtype', (
        ...
        db.send_create_signal(u'devices', ['DevType'])
        ...
        db.create_table(u'devices_device', (
            ...
            ('devtype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.DevType'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'devices_devtype')
