...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Measuring.quality'
        db.add_column(u'devices_measuring', 'quality',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Measuring.capacity'
        db.add_column(u'devices_measuring', 'capacity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Measuring.quality'
        db.delete_column(u'devices_measuring', 'quality')

        # Deleting field 'Measuring.capacity'
        db.delete_column(u'devices_measuring', 'capacity')
    ...
    models = {
        ...
        u'devices.measuring': {
            'Meta': {'ordering': "['-date']", 'object_name': 'Measuring'},
