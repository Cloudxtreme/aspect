...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Measuring'
        db.create_table(u'devices_measuring', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Device'])),
            ('mac', self.gf('django.db.models.fields.CharField')(default='', max_length=17, null=True, blank=True)),
        ...
        db.send_create_signal(u'devices', ['Measuring'])


    def backwards(self, orm):
        # Deleting model 'Measuring'
        db.delete_table(u'devices_measuring')
