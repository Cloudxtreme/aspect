...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DevType.supply'
        db.delete_column(u'devices_devtype', 'supply')

        # Deleting field 'DevType.ports'
        db.delete_column(u'devices_devtype', 'ports')

        # Adding field 'DevType.category'
        db.add_column(u'devices_devtype', 'category',
                      self.gf('django.db.models.fields.CharField')(default='S', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DevType.supply'
        db.add_column(u'devices_devtype', 'supply',
                      self.gf('django.db.models.fields.CharField')(default='220V', max_length=4),
                      keep_default=False)

        # Adding field 'DevType.ports'
        db.add_column(u'devices_devtype', 'ports',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'DevType.category'
        db.delete_column(u'devices_devtype', 'category')
    ...
    models = {
        ...
        u'devices.devtype': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_radio': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
