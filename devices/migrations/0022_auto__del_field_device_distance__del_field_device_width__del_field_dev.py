...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Device.distance'
        db.delete_column(u'devices_device', 'distance')

        # Deleting field 'Device.width'
        db.delete_column(u'devices_device', 'width')

        # Deleting field 'Device.freqs'
        db.delete_column(u'devices_device', 'freqs')

        # Deleting field 'Device.mac'
        db.delete_column(u'devices_device', 'mac')

        # Deleting field 'Device.ap'
        db.delete_column(u'devices_device', 'ap')

        # Deleting field 'Device.azimuth'
        db.delete_column(u'devices_device', 'azimuth')

        # Adding field 'Device.details_map_field'
        db.add_column(u'devices_device', 'details_map_field',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Device.distance'
        db.add_column(u'devices_device', 'distance',
                      self.gf('django.db.models.fields.FloatField')(default='0'),
                      keep_default=False)

        # Adding field 'Device.width'
        db.add_column(u'devices_device', 'width',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2),
                      keep_default=False)

        # Adding field 'Device.freqs'
        db.add_column(u'devices_device', 'freqs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Device.mac'
        db.add_column(u'devices_device', 'mac',
        ...
        # Adding field 'Device.azimuth'
        db.add_column(u'devices_device', 'azimuth',
                      self.gf('django.db.models.fields.FloatField')(default='0'),
                      keep_default=False)

        # Deleting field 'Device.details_map_field'
        db.delete_column(u'devices_device', 'details_map_field')
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'details_map_field': ('django.db.models.fields.TextField', [], {}),
