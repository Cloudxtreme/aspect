...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.peer'
        db.add_column(u'devices_device', 'peer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Device'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.peer'
        db.delete_column(u'devices_device', 'peer_id')
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'peer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Device']", 'null': 'True', 'blank': 'True'}),
