...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Device.is_rooter'
        db.delete_column(u'devices_device', 'is_rooter')

        # Adding field 'Device.router'
        db.add_column(u'devices_device', 'router',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Device.is_rooter'
        db.add_column(u'devices_device', 'is_rooter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Device.router'
        db.delete_column(u'devices_device', 'router')
