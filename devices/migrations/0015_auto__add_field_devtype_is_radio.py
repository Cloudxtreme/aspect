...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DevType.is_radio'
        db.add_column(u'devices_devtype', 'is_radio',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DevType.is_radio'
        db.delete_column(u'devices_devtype', 'is_radio')
    ...
    models = {
        ...
        u'devices.devtype': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_radio': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
