...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubInterface'
        db.create_table(u'devices_subinterface', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('ip', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['vlans.IPAddr'], unique=True)),
        ))
        db.send_create_signal(u'devices', ['SubInterface'])

        # Adding M2M table for field sub_ifaces on 'Device'
        m2m_table_name = db.shorten_name(u'devices_device_sub_ifaces')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('device', models.ForeignKey(orm[u'devices.device'], null=False)),
            ('subinterface', models.ForeignKey(orm[u'devices.subinterface'], null=False))
        ))
        db.create_unique(m2m_table_name, ['device_id', 'subinterface_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SubInterface'
        db.delete_table(u'devices_subinterface')

        # Removing M2M table for field sub_ifaces on 'Device'
        db.delete_table(db.shorten_name(u'devices_device_sub_ifaces'))
    ...
    models = {
        u'devices.device': {
            ...
            'sub_ifaces': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['devices.SubInterface']", 'null': 'True', 'blank': 'True'}),
