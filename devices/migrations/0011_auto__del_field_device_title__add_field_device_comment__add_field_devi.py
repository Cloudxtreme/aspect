...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Device.title'
        db.delete_column(u'devices_device', 'title')

        # Adding field 'Device.comment'
        db.add_column(u'devices_device', 'comment',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Device.location'
        db.add_column(u'devices_device', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vlans.Location'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Device.title'
        db.add_column(u'devices_device', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Deleting field 'Device.comment'
        db.delete_column(u'devices_device', 'comment')

        # Deleting field 'Device.location'
        db.delete_column(u'devices_device', 'location_id')
