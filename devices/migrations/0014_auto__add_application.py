...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'devices_application', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type_app', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('ipaddr', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('tinymce.models.HTMLField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'devices', ['Application'])


    def backwards(self, orm):
        # Deleting model 'Application'
        db.delete_table(u'devices_application')
