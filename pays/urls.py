...
urlpatterns = patterns('',
    ...
    url(r'^abonent/(?P<abonent_id>\d+)/promisedpays/all$','pays.views.promisedpays', name='promisedpays'),
    url(r'^abonent/(?P<abonent_id>\d+)/promisedpay/add$','pays.views.add_promisedpay', name='addpromisedpay'),
    url(r'^abonent/(?P<abonent_id>\d+)/promisedpay/(?P<promisedpay_id>\d+)/close$','pays.views.close_promisedpay', name='closepromisedpay'),
)