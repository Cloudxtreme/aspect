...
urlpatterns = patterns('',
    ...
    url(r'^abonent/(?P<abonent_id>\d+)/revise$','pays.views.revise', name='revise'),
    url(r'^abonent/(?P<abonent_id>\d+)/reserve_check_balance$','pays.views.reserve_check_balance', name='reserve_check_balance'),
