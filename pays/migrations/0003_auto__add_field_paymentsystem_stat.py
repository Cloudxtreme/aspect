...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentSystem.stat'
        db.add_column(u'pays_paymentsystem', 'stat',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentSystem.stat'
        db.delete_column(u'pays_paymentsystem', 'stat')
    ...
    models = {
        ...
        u'pays.payment': {
            ...
            'stat': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
