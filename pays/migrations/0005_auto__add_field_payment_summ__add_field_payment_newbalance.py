...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.summ'
        db.add_column(u'pays_payment', 'summ',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Payment.newbalance'
        db.add_column(u'pays_payment', 'newbalance',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.summ'
        db.delete_column(u'pays_payment', 'summ')

        # Deleting field 'Payment.newbalance'
        db.delete_column(u'pays_payment', 'newbalance')
