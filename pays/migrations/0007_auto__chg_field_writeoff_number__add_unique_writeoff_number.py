...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WriteOff.number'
        db.alter_column(u'pays_writeoff', 'number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))
        # Adding unique constraint on 'WriteOff', fields ['number']
        db.create_unique(u'pays_writeoff', ['number'])


    def backwards(self, orm):
        # Removing unique constraint on 'WriteOff', fields ['number']
        db.delete_unique(u'pays_writeoff', ['number'])


        # Changing field 'WriteOff.number'
        db.alter_column(u'pays_writeoff', 'number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        u'pays.payment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'num': ('django.db.models.fields.CharField', [], {'default': "u'\\u041f\\u041b\\u0410\\u0422\\u0415\\u0416-5'", 'unique': 'True', 'max_length': '30'}),
        ...
        u'pays.writeoff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.CharField', [], {'default': "u'\\u0421\\u041f\\u0418\\u0421\\u0410\\u041d\\u0418\\u0415-3'", 'unique': 'True', 'max_length': '20'}),
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
