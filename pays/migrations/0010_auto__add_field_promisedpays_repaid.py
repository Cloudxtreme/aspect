...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PromisedPays.repaid'
        db.add_column(u'pays_promisedpays', 'repaid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PromisedPays.repaid'
        db.delete_column(u'pays_promisedpays', 'repaid')
    ...
    models = {
        ...
        u'pays.payment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'num': ('django.db.models.fields.CharField', [], {'default': "u'000022'", 'unique': 'True', 'max_length': '30'}),
        ...
        u'pays.writeoff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.CharField', [], {'default': "u'000023'", 'unique': 'True', 'max_length': '20'}),
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
