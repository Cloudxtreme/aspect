...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.abonent'
        db.add_column(u'pays_payment', 'abonent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='abonent', to=orm['users.Abonent']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.abonent'
        db.delete_column(u'pays_payment', 'abonent_id')
    ...
    models = {
        ...
        u'pays.payment': {
            ...
            'abon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'old_abonent'", 'to': u"orm['users.Abonent']"}),
            ...
            'num': ('django.db.models.fields.CharField', [], {'default': 'None', 'unique': 'True', 'max_length': '30'}),
        ...
        u'pays.writeoff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.CharField', [], {'default': "u'001649'", 'unique': 'True', 'max_length': '20'}),
