...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Payment.sum'
        db.delete_column(u'pays_payment', 'sum')

        # Deleting field 'Payment.abon'
        db.delete_column(u'pays_payment', 'abon_id')


    def backwards(self, orm):
        # Adding field 'Payment.sum'
        db.add_column(u'pays_payment', 'sum',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Payment.abon'
        db.add_column(u'pays_payment', 'abon',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='old_abonent', to=orm['users.Abonent']),
                      keep_default=False)
