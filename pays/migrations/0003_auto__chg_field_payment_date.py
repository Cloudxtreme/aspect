...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'pays_payment', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Payment.date'
        db.alter_column(u'pays_payment', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
