...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.num'
        db.alter_column(u'pays_payment', 'num', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))
        # Adding unique constraint on 'Payment', fields ['num']
        db.create_unique(u'pays_payment', ['num'])


    def backwards(self, orm):
        # Removing unique constraint on 'Payment', fields ['num']
        db.delete_unique(u'pays_payment', ['num'])


        # Changing field 'Payment.num'
        db.alter_column(u'pays_payment', 'num', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
