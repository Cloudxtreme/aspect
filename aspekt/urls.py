...
urlpatterns = patterns('',
    ...
    url(r'^ajax/check_mac/$', 'devices.views.check_mac', name='check_mac'),
    ...
    url(r'^ajax/do_measuring/$', 'devices.views.do_measuring'),
    url(r'^ajax/measuring_list/$', 'devices.views.measuring_list'),
    ...
    url(r'^block/$', 'users.views.block', name='block'),
