...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rent'
        db.create_table(u'vlans_rent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('cost', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal(u'vlans', ['Rent'])

        # Adding field 'Location.rent'
        db.add_column(u'vlans_location', 'rent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vlans.Rent'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Rent'
        db.delete_table(u'vlans_rent')

        # Deleting field 'Location.rent'
        db.delete_column(u'vlans_location', 'rent_id')
