...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'vlans_location', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Location.address'
        db.alter_column(u'vlans_location', 'address', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):
        # Deleting field 'Location.title'
        db.delete_column(u'vlans_location', 'title')


        # Changing field 'Location.address'
        db.alter_column(u'vlans_location', 'address', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
