...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Vlan', fields ['number']
        db.create_unique(u'vlans_vlan', ['number'])

        # Adding field 'Location.geolocation'
        db.add_column(u'vlans_location', 'geolocation',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Vlan', fields ['number']
        db.delete_unique(u'vlans_vlan', ['number'])

        # Deleting field 'Location.geolocation'
        db.delete_column(u'vlans_location', 'geolocation')
