...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Network.description'
        db.add_column(u'vlans_network', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Network.description'
        db.delete_column(u'vlans_network', 'description')
