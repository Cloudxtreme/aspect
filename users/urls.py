...
urlpatterns = patterns('',
    ...
    url(r'^(?P<abonent_id>\d+)/services/(?P<service_id>\d+)/add/$', 'users.views.service_add'),
    url(r'^(?P<abonent_id>\d+)/services/(?P<service_id>\d+)/edit/$', 'users.views.service_edit'),
    url(r'^(?P<abonent_id>\d+)/services/(?P<service_id>\d+)/plan/edit/$', 'users.views.service_plan_changes'),
