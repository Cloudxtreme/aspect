...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plan.utype'
        db.add_column(u'users_plan', 'utype',
                      self.gf('django.db.models.fields.CharField')(default='U', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plan.utype'
        db.delete_column(u'users_plan', 'utype')
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['vlans.IPAddr']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
