...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TypeOfService.visible'
        db.add_column(u'users_typeofservice', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TypeOfService.visible'
        db.delete_column(u'users_typeofservice', 'visible')
