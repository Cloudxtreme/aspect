...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Service.mac'
        db.alter_column(u'users_service', 'mac', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

    def backwards(self, orm):

        # Changing field 'Service.mac'
        db.alter_column(u'users_service', 'mac', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
