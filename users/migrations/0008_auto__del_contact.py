...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'users.abonent': {
            ...
            'contact': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['contacts.Contact']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
