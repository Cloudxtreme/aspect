...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field vlan_list on 'Service'
        m2m_table_name = db.shorten_name(u'users_service_vlan_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('service', models.ForeignKey(orm[u'users.service'], null=False)),
            ('vlan', models.ForeignKey(orm[u'vlans.vlan'], null=False))
        ))
        db.create_unique(m2m_table_name, ['service_id', 'vlan_id'])


    def backwards(self, orm):
        # Removing M2M table for field vlan_list on 'Service'
        db.delete_table(db.shorten_name(u'users_service_vlan_list'))
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['vlans.IPAddr']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
