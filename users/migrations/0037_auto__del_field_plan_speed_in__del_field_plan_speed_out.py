...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Plan.speed_in'
        db.delete_column(u'users_plan', 'speed_in')

        # Deleting field 'Plan.speed_out'
        db.delete_column(u'users_plan', 'speed_out')


    def backwards(self, orm):
        # Adding field 'Plan.speed_in'
        db.add_column(u'users_plan', 'speed_in',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plan.speed_out'
        db.add_column(u'users_plan', 'speed_out',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)
