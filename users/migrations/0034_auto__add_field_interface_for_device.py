...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interface.for_device'
        db.add_column(u'users_interface', 'for_device',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interface.for_device'
        db.delete_column(u'users_interface', 'for_device')
