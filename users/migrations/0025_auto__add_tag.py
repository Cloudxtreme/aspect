...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tag on 'Abonent'
        m2m_table_name = db.shorten_name(u'users_abonent_tag')
        ...
        db.create_unique(m2m_table_name, ['abonent_id', 'tag_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field tag on 'Abonent'
        db.delete_table(db.shorten_name(u'users_abonent_tag'))
    ...
    models = {
        ...
        u'users.abonent': {
            ...
            'tag': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['users.Tag']", 'symmetrical': 'False'}),
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['vlans.IPAddr']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
