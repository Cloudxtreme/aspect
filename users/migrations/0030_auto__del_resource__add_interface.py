...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'users_resource')

        # Adding model 'Interface'
        db.create_table(u'users_interface', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mac', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('ip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vlans.IPAddr'], unique=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'users', ['Interface'])

        # Adding M2M table for field ifaces on 'Service'
        m2m_table_name = db.shorten_name(u'users_service_ifaces')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('service', models.ForeignKey(orm[u'users.service'], null=False)),
            ('interface', models.ForeignKey(orm[u'users.interface'], null=False))
        ))
        db.create_unique(m2m_table_name, ['service_id', 'interface_id'])


    def backwards(self, orm):
        # Adding model 'Resource'
        db.create_table(u'users_resource', (
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Service'])),
            ('ip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vlans.IPAddr'], unique=True)),
            ('mac', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'users', ['Resource'])

        # Deleting model 'Interface'
        db.delete_table(u'users_interface')

        # Removing M2M table for field ifaces on 'Service'
        db.delete_table(db.shorten_name(u'users_service_ifaces'))
    ...
    models = {
        ...
        u'devices.iface': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['vlans.IPAddr']", 'unique': 'True'}),
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
