...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Interface.comment'
        db.alter_column(u'users_interface', 'comment', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
        # Deleting field 'Service.vlan'
        db.delete_column(u'users_service', 'vlan_id')


    def backwards(self, orm):

        # Changing field 'Interface.comment'
        db.alter_column(u'users_interface', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=300))
        # Adding field 'Service.vlan'
        db.add_column(u'users_service', 'vlan',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='vlan', null=True, to=orm['vlans.Vlan'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
