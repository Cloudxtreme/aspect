...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Service.speed'
        db.add_column(u'users_service', 'speed',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Pipe'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plan.speed'
        db.add_column(u'users_plan', 'speed',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Pipe']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Service.speed'
        db.delete_column(u'users_service', 'speed_id')

        # Deleting field 'Plan.speed'
        db.delete_column(u'users_plan', 'speed_id')
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
