...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pipe'
        db.create_table(u'users_pipe', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('speed_in', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True)),
            ('speed_out', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal(u'users', ['Pipe'])

        # Deleting field 'Service.speed_out'
        db.delete_column(u'users_service', 'speed_out')

        # Deleting field 'Service.speed_in'
        db.delete_column(u'users_service', 'speed_in')

        # Adding field 'Service.pipe'
        db.add_column(u'users_service', 'pipe',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Pipe'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Pipe'
        db.delete_table(u'users_pipe')

        # Adding field 'Service.speed_out'
        db.add_column(u'users_service', 'speed_out',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.speed_in'
        db.add_column(u'users_service', 'speed_in',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Service.pipe'
        db.delete_column(u'users_service', 'pipe_id')
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ifaces': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['users.Interface']", 'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['vlans.Location']", 'null': 'True', 'blank': 'True'}),
            'pipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Pipe']", 'null': 'True', 'blank': 'True'}),
