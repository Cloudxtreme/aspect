...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'users_service', 'vlan_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='vlan_temp', null=True, to=orm['vlans.Vlan'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'users.service': {
            ...
            'vlan': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'vlan_old'", 'unique': 'True', 'null': 'True', 'to': u"orm['vlans.Vlan']"})
        },
