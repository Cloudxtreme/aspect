...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Service.ip'
        db.delete_column(u'users_service', 'ip_id')


    def backwards(self, orm):
        # Adding field 'Service.ip'
        db.add_column(u'users_service', 'ip',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['vlans.IPAddr'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 17, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
