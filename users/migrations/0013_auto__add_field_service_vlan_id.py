...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.vlan_id'
        db.add_column(u'users_service', 'vlan_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='vlan_temp', null=True, to=orm['vlans.Vlan']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.vlan_id'
        db.delete_column(u'users_service', 'vlan_id_id')
    ...
    models = {
        ...
        u'users.service': {
            ...
            'vlan_id': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'vlan_temp'", 'null': 'True', 'to': u"orm['vlans.Vlan']"})
        },
