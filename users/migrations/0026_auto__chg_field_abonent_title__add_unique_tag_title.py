...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Abonent.title'
        db.alter_column(u'users_abonent', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Adding unique constraint on 'Tag', fields ['title']
        db.create_unique(u'users_tag', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Tag', fields ['title']
        db.delete_unique(u'users_tag', ['title'])


        # Changing field 'Abonent.title'
        db.alter_column(u'users_abonent', 'title', self.gf('django.db.models.fields.CharField')(max_length=70))
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['vlans.IPAddr']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
