...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Service.speed_in'
        db.alter_column(u'users_service', 'speed_in', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Service.speed_out'
        db.alter_column(u'users_service', 'speed_out', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Service.speed_in'
        db.alter_column(u'users_service', 'speed_in', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Service.speed_out'
        db.alter_column(u'users_service', 'speed_out', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
