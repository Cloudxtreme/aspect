...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Abonent.vip'
        db.add_column(u'users_abonent', 'vip',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Abonent.vip'
        db.delete_column(u'users_abonent', 'vip')
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['vlans.IPAddr']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
