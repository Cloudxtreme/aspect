...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Service.mac'
        db.delete_column(u'users_service', 'mac')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Service.mac'
        db.add_column(u'users_service', 'mac',
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 6, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['vlans.IPAddr']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'ip_list': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'resources'", 'to': u"orm['vlans.IPAddr']", 'through': u"orm['users.Resource']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
