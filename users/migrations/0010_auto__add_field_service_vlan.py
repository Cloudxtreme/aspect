...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'users_service', 'vlan',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['vlans.Vlan'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
