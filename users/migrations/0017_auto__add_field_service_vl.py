...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.vl'
        db.add_column(u'users_service', 'vl',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='vl', null=True, to=orm['vlans.Vlan']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.vl'
        db.delete_column(u'users_service', 'vl_id')
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['vlans.IPAddr']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'vl': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'vl'", 'null': 'True', 'to': u"orm['vlans.Vlan']"}),
            'vlan': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'vlan'", 'unique': 'True', 'null': 'True', 'to': u"orm['vlans.Vlan']"})
        },
