...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Abonent.notice_email'
        db.add_column(u'users_abonent', 'notice_email',
                      self.gf('django.db.models.fields.CharField')(max_length=70, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Abonent.notice_mobile'
        db.add_column(u'users_abonent', 'notice_mobile',
                      self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Abonent.notice_email'
        db.delete_column(u'users_abonent', 'notice_email')

        # Deleting field 'Abonent.notice_mobile'
        db.delete_column(u'users_abonent', 'notice_mobile')
