...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Service.bs_device'
        db.delete_column(u'users_service', 'bs_device_id')

        # Deleting field 'Service.user_device'
        db.delete_column(u'users_service', 'user_device_id')

        # Adding field 'Service.device'
        db.add_column(u'users_service', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Device'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Service.bs_device'
        db.add_column(u'users_service', 'bs_device',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='bs_device', null=True, to=orm['devices.Device'], blank=True),
                      keep_default=False)

        # Adding field 'Service.user_device'
        db.add_column(u'users_service', 'user_device',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_device', null=True, to=orm['devices.Device'], blank=True),
                      keep_default=False)

        # Deleting field 'Service.device'
        db.delete_column(u'users_service', 'device_id')
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 13, 0, 0)'}),
