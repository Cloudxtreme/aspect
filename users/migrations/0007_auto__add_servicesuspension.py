...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServiceSuspension'
        db.create_table(u'users_servicesuspension', (
        ...
        db.send_create_signal(u'users', ['ServiceSuspension'])


    def backwards(self, orm):
        # Deleting model 'ServiceSuspension'
        db.delete_table(u'users_servicesuspension')
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 4, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
