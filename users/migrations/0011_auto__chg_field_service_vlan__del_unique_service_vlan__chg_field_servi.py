...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Service', fields ['vlan']
        db.delete_unique(u'users_service', ['vlan_id'])


        # Changing field 'Service.vlan'
        db.alter_column(u'users_service', 'vlan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vlans.Vlan'], null=True))

        # Changing field 'Service.user_device'
        db.alter_column(u'users_service', 'user_device_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['devices.Device']))

        # Changing field 'Service.bs_device'
        db.alter_column(u'users_service', 'bs_device_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['devices.Device']))

    def backwards(self, orm):

        # Changing field 'Service.vlan'
        db.alter_column(u'users_service', 'vlan_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['vlans.Vlan'], unique=True, null=True))
        # Adding unique constraint on 'Service', fields ['vlan']
        db.create_unique(u'users_service', ['vlan_id'])


        # Changing field 'Service.user_device'
        db.alter_column(u'users_service', 'user_device_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['vlans.Device']))

        # Changing field 'Service.bs_device'
        db.alter_column(u'users_service', 'bs_device_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['vlans.Device']))
    ...
    models = {
        ...
        u'users.service': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['vlans.IPAddr']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
