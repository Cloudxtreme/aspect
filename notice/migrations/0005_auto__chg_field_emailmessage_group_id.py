...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailMessage.group_id'
        db.alter_column(u'notice_emailmessage', 'group_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'EmailMessage.group_id'
        db.alter_column(u'notice_emailmessage', 'group_id', self.gf('django.db.models.fields.IntegerField')())
