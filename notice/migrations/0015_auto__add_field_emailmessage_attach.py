...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailMessage.attach'
        db.add_column(u'notice_emailmessage', 'attach',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailMessage.attach'
        db.delete_column(u'notice_emailmessage', 'attach')
