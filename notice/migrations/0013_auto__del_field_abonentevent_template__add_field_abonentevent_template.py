...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AbonentEvent.template'
        db.delete_column(u'notice_abonentevent', 'template_id')

        # Adding field 'AbonentEvent.template_fiz'
        db.add_column(u'notice_abonentevent', 'template_fiz',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='template_fiz', null=True, to=orm['notice.TemplateMessage']),
                      keep_default=False)

        # Adding field 'AbonentEvent.template_ur'
        db.add_column(u'notice_abonentevent', 'template_ur',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='template_ur', null=True, to=orm['notice.TemplateMessage']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AbonentEvent.template'
        db.add_column(u'notice_abonentevent', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notice.TemplateMessage'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AbonentEvent.template_fiz'
        db.delete_column(u'notice_abonentevent', 'template_fiz_id')

        # Deleting field 'AbonentEvent.template_ur'
        db.delete_column(u'notice_abonentevent', 'template_ur_id')
