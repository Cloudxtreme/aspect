...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notice_templatemessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('content', self.gf('tinymce.models.HTMLField')()),
        ))
        db.send_create_signal(u'notice', ['TemplateMessage'])

        # Adding model 'AbonentEvent'
        db.create_table(u'notice_abonentevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notice.TemplateMessage'])),
        ))
        db.send_create_signal(u'notice', ['AbonentEvent'])


    def backwards(self, orm):
        # Deleting model 'TemplateMessage'
        db.delete_table(u'notice_templatemessage')

        # Deleting model 'AbonentEvent'
        db.delete_table(u'notice_abonentevent')
    ...
    models = {
        u'notice.abonentevent': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['notice.TemplateMessage']"}),
