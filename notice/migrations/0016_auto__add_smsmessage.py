...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notice_smsmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('abonent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Abonent'], null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=280)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ))
        db.send_create_signal(u'notice', ['SMSMessage'])


    def backwards(self, orm):
        # Deleting model 'SMSMessage'
        db.delete_table(u'notice_smsmessage')
    ...
    models = {
        ...
        u'notice.emailmessage': {
            'Meta': {'ordering': "['sent', '-pk']", 'object_name': 'EmailMessage'},
        ...
        u'notice.smsmessage': {
            ...
            'text': ('django.db.models.fields.CharField', [], {'max_length': '280'})
        },
