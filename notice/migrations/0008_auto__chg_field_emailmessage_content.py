...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'notice_emailmessage', 'content', self.gf('tinymce.models.HTMLField')())

    def backwards(self, orm):

        # Changing field 'EmailMessage.content'
        db.alter_column(u'notice_emailmessage', 'content', self.gf('django.db.models.fields.TextField')())
